...
# ------------------------------------
def train_critic_bellman(soft_solver, critic_net, optimizer, num_epochs=100, N=100, batch_size=500):
    """
...
if __name__ == "__main__":
    ...
    losses = train_critic_bellman(soft_solver, critic_net, optimizer, num_epochs=100, N=100, batch_size=500)
...
# Call the plotting function to visualize value surfaces at a fixed time (t = 1/6).
plot_value_surface(critic_net, soft_solver, t_fixed=1/6)
